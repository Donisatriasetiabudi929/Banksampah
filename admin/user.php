...
<body>
		...
		<tbody>
			<?php 
                ...
                if(isset($_GET['cari'])) {
                    $pencarian = $_GET['cari'];
                    $tutu = "SELECT * FROM profiletamu WHERE NAMA LIKE '%".$pencarian."%'";
                }else {
                    $tutu = "SELECT * FROM profiletamu";
                }
            ...
            <tr>
                ...
                <td class="test8">Rp. <?php echo $profiletamu['SALDO'] ?></td>
                <td><a href="aktivitas.php?ID_USER=<?php echo $profiletamu['ID_USER'] ?>">LIHAT AKTIVITAS</a></td>
            </tr>
            <?php } ?>
		</tbody>
	</table>
