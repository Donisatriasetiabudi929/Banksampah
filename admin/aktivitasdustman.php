<?php
    ...
    if(!isset($_GET['ID_USER'])) {
        header('Location: dustman.php');  
    }
    $id = $_GET['ID_USER'];
    $sql = "SELECT * FROM profiledustman WHERE ID_USER='$_GET[ID_USER]'";
...
<div class="container">
        ...
        <table border="1">
            ...
            <?php
                include 'config.php';
                $sql = "SELECT * FROM aktivitasdustman WHERE ID_USER = $id ORDER BY ID DESC";
                $query = mysqli_query($conn, $sql);
            ...
            <tr>
                ...
                <td><?php echo $aktivitas['JUMLAH'] ?> KG</td>
            </tr>
            <?php } ?>
        </table>
    </div>
